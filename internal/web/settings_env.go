...
func allEnvSettingDefinitions() []envSettingDefinition {
	...
	return []envSettingDefinition{
		...
		{Key: "XALGORIX_DISABLE_AUTO_DELEGATE", Label: "Disable specialist wave", Category: "LLM", Description: "Skip the automatic specialist delegation wave entirely. The root agent does all testing itself — deeper but slower (pre-v4.6.93 behavior). Enable if specialist-parallel scans are producing shallower results.", DefaultValue: "true", InputType: "boolean"},
